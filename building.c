...
/* 
  ...
  Purpose: Loads building structure
  Params:   
		In: BuildingType *building - Pointer to specified BuildingType to be initialized
*/
...
/* 
  ...
  Purpose: Initializes BuildingType through its respective elements (defined in defs.h) - ghosts and rooms
  Params:   
		In: BuildingType *b - Pointer to specified BuildingType to be initialized
*/
...
/* 
  ...
  Purpose: Cleans up all associated memory for BuildingType (rooms, ghost data, GhostListType nodes)
  Params:   
		In: BuildingType *b - Pointer to specified BuildingType to be cleaned
*/
